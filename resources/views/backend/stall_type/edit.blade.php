...
<!-- Main page content-->
<form action="{{ route('stall-type-update', $sty->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <select class="form-control js-example-basic-single" id="stall_type" name="stall_type">
                        ...
                        <option value="Los" {{ $sty->stall_type == 'Los' ? 'selected' : '' }}>
                            Los
                        </option>
                    </select>
                </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <select class="form-control js-example-basic-single" id="area" name="area">
                        ...
                        <option value="0 - 5 m2" {{ $sty->area == '0 - 5 m2' ? 'selected' : '' }}>
                            0 - 5 m2
                        </option>
                        <option value="6 - 10 m2" {{ $sty->area == '6 - 10 m2' ? 'selected' : '' }}>
                            6 - 10 m2
                        </option>
                        <option value="11 - 15 m2" {{ $sty->area == '11 - 15 m2' ? 'selected' : '' }}>
                            11 - 15 m2
                        </option>
                        <option value="16 - 20 m2" {{ $sty->area == '16 - 20 m2' ? 'selected' : '' }}>
                            16 - 20 m2
                        </option>
                    </select>
                </div>
