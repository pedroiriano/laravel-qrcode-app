<script>
    $(function() {
        ...
        var monthCompare = <?php echo $monthCompare; ?>;
        var cData = JSON.parse('<?php echo $data; ?>');
        var cDataCompare = JSON.parse('<?php echo $dataCompare; ?>');
        var ctx = $("#weeklyAreaChart");
        // Chart Data
        var data = {
            labels: cData.label,
            datasets: [
        ...
        var options = {
            ...
            title: {
                display: true,
                position: "top",
                text: "Perbandingan Harga Komoditas "+commodityName+" Mingguan - Tahun "+year,
                fontSize: 15,
                fontColor: "#111"
            },
            legend: {
